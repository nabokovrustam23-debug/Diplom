...
![Рисунок 2.1 — ER-диаграмма CRM-системы](img/er-diagram.png)
...
Графические макеты прототипа приведены в приложении Г «Экранные формы пользовательского интерфейса» в виде скриншотов; оформление макетов выполняется в инструменте Figma.
